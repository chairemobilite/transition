 ...
 */
import type { MapMouseEvent, MapLayerMouseEvent, MapEventType, MapLayerEventType } from 'maplibre-gl';

type MapEventHandler = (e: MapMouseEvent) => void;
type MapLayerEventHandler = (e: MapLayerMouseEvent) => void;
