...
// returns value as seconds, rounded, ceiled or floored to the nearest 15 seconds:
const roundSecondsToNearestQuarterMinute = function (seconds: number, rounding = Math.ceil): number {
    return rounding(seconds / 15) * 15;
};
