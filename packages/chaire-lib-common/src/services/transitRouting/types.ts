...
export enum ErrorCodes {
    ...
    NoAccessAtDestination = 'TRROUTING_NO_ROUTING_NO_ACCESS_AT_DESTINATION',
    NoAccessAtOriginAndDestination = 'TRROUTING_NO_ROUTING_NO_ACCESS_AT_ORIGIN_AND_DESTINATION',
    ...
    NoAccessAtPlace = 'TRROUTING_NO_ROUTING_NO_ACCESS_AT_PLACE',
