...
function WayHandlers.names(profile,way,result,data)
  ...
  local segregated = way:get_value_by_key("segregated")
  local access = way:get_value_by_key("access")
  local foot_access = way:get_value_by_key("foot")
  ...
  result.name = "w" .. tostring(id) .. "|"
  if highway == "footway" then
    result.name = result.name .. "h_foot|"
  elseif highway == "cycleway" then
    result.name = result.name.. "h_cycle|"
  elseif highway == "path" then
    result.name = result.name .. "h_path|"
  elseif highway == "residential" then
    result.name = result.name .. "h_res|"
  elseif highway == "tertiary" then
    result.name = result.name .. "h_ter|"
  elseif highway == "tertiary_link" then
    result.name = result.name .. "h_terl|"
  elseif highway == "secondary" then
    result.name = result.name .. "h_sec|"
  elseif highway == "secondary_link" then
    result.name = result.name .. "h_secl|"
  elseif highway == "primary" then
    result.name = result.name .. "h_pri|"
  elseif highway == "primary_link" then
    result.name = result.name .. "h_pril|"
  elseif highway == "trunk" then
    result.name = result.name .. "h_tr|"
  elseif highway == "trunk_link" then
    result.name = result.name .. "h_trl|"
  elseif highway == "unclassified" then
    result.name = result.name .. "h_unc|"
  elseif highway == "motorway" then
    result.name = result.name .. "h_mw|"
  elseif highway == "motorway_link" then
    result.name = result.name .. "h_mwl|"
  elseif highway == "living_street" then
    result.name = result.name .. "h_livs|"
  elseif highway == "service" then
    result.name = result.name .. "h_ser|"
  elseif highway == "pedestrian" then
    result.name = result.name .. "h_ped|"
  elseif highway == "track" then
    result.name = result.name .. "h_track|"
  elseif highway == "bus_guideway" then
    result.name = result.name .. "h_busg|"
  elseif highway == "busway" then
    result.name = result.name .. "h_busw|"
  elseif highway == "escape" then
    result.name = result.name .. "h_esc|"
  elseif highway == "raceway" then
    result.name = result.name .. "h_racew|"
  elseif highway == "bridleway" then
    result.name = result.name .. "h_briw|"
  elseif highway == "steps" then
    result.name = result.name .. "h_steps|"
  elseif highway == "corridor" then
    result.name = result.name .. "h_cor|"
  elseif highway == "construction" then
    result.name = result.name .. "h_const|"
  end

  if footway == "sidewalk" then
    result.name = result.name .. "sidewalk|"
  elseif footway == "crossing" and crossing == "unmarked" then
    result.name = result.name .. "crossing_unmarked|"
  elseif footway == "crossing" and crossing == "marked" then
    result.name = result.name .. "crossing_marked|"
  elseif cycleway == "crossing" and crossing == "unmarked" then
    result.name = result.name .. "crossing_unmarked|"
  elseif cycleway == "crossing" and crossing == "marked" then
    result.name = result.name .. "crossing_marked|"
  elseif footway == "crossing" then
    result.name = result.name .. "crossing_unknown|"
  elseif sidewalk == "shared" then
    result.name = result.name .. "shared|"
  elseif highway == "pedestrian" then
    result.name = result.name .. "pedestrian|"
  elseif highway == "living_street" then
    result.name = result.name .. "living_street|"
  elseif highway == "service" then
    result.name = result.name .. "service|"
  elseif highway == "footway" or highway == "corridor" then
    result.name = result.name .. "footway|"
  elseif highway == "steps" then
    result.name = result.name .. "steps|"
  elseif highway == "path" then
    result.name = result.name .. "path|"
  elseif highway == "construction" or highway == "construction"  then
    result.name = result.name .. "path|"
  elseif highway == "cycleway" and segregated == "yes" then
    result.name = result.name .. "cycleway_segregated_yes|"
  elseif highway == "cycleway" and segregated == "no" then
    result.name = result.name .. "cycleway_segregated_no|"
  elseif highway == "cycleway" then
    result.name = result.name .. "cycleway_segregated_unknown|"
  elseif highway == "track" or highway == "bridleway" then
    result.name = result.name .. "track|"
  elseif highway == "escape" or highway == "raceway" then
    result.name = result.name .. "other|"
  else
    result.name = result.name .. "no_sidewalk|"
  end
