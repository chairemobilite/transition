...
describe('OSRM Service Manager', () => {

    beforeEach(() => {
        const verbose = false; // make it true to see additional verbose output
    ...
    test('should extract, contract and/or prepare osm file for single mode walking with default config', async () => {
    ...
    test('should extract, contract and/or prepare osm file for all modes with default config', async () => {
    ...
    test('should extract, contract and/or prepare osm file for single mode walking with custom config', async () => {
    ...
    test('should extract, contract and/or prepare osm file for single mode walking with no prefix', async () => {
    ...
    test('should return an error if osm file does not exists', async () => {
    ...
    test('should start only walking and update preferences', async () => {
        ...
        const autoStartOsrm : RoutingMode[] = [];
        ...
        const containsAll = (baseArray: string[], contained: string[]): boolean => contained.every((v) => baseArray.includes(v));
    ...
    test('should not start servers if start is not request, even if autostart is true', async () => {
        ...
        for (let i = 0; i < availableOsrms.length; i++) {
            expect(OSRMService.getMode(availableOsrms[i] as RoutingMode)).toBeDefined();
        }
