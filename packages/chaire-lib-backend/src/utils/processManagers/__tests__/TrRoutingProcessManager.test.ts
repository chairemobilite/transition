...
describe('TrRouting Process Manager: start', () => {
    ...
    test('start process from default path', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            ['--port=4000', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=2'],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start process with a specific port number', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            './trRouting',
            ['--port=1234', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=2'],
            'ready.',
            false,
            __dirname,
            false
    ...
    test('start process with a custom cache directory', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            './trRouting',
            ['--port=4000', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=/tmp/cache`, '--threads=2'],
            'ready.',
            false,
            __dirname,
            false
    ...
    test('start process with configured port and cacheAllScenarios for single trRouting', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            [`--port=${port}`, '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=2', '--cacheAllConnectionSets=true'],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start process with deprecated trRoutingCacheAllScenarios configuration option', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            ['--port=4000', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=2', '--cacheAllConnectionSets=true'],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start batch process with 1 cpu', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            ['--port=14000', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start batch process with 4 cpus', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            ['--port=14000', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=4'],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start batch process with 4 cpus with 2 limit', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            ['--port=14000', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=2'],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start batch process with 4 cpus on a custom port', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            ['--port=12345', '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=4'],
            'ready.',
            false,
            undefined,
            false
    ...
    test('start batch process with 4 cpus with port and cacheAll configuration', async () => {
        ...
        expect(startProcessMock).toHaveBeenCalledWith(
            ...
            'trRouting',
            'trRouting',
            [`--port=${port}`, '--useEuclideanDistance=0', `--osrmPort=${walkingOsrmMode.getHostPort().port}`, `--osrmHost=${walkingOsrmMode.getHostPort().host}`, '--debug=0', `--cachePath=${directoryManager.projectDirectory}/cache/test`, '--threads=4', '--cacheAllConnectionSets=true'],
            'ready.',
            false,
            undefined,
            false
