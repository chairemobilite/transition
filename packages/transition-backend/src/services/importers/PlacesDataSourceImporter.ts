...
// FIXME This prompt works only on command line where the user can answer. Need to support arbitrary prompts, like going through a web interface.
...
/**
 * Import the points from the geojson file into the database, in the data source with the given name. If the data source already exists, the user will be prompted to confirm overwriting the existing data.
