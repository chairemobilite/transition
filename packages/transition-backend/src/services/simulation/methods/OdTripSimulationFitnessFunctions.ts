 ...
 */
export const odTripFitnessFunctions: { [key: string]: OdTripFitnessFunction } = {
 ...
 */
export const nonRoutableOdTripFitnessFunctions: { [key: string]: NonRoutableTripFitnessFunction } = {
 ...
 */
export const fitnessFunctions: { [key: string]: FitnessFunction } = {
