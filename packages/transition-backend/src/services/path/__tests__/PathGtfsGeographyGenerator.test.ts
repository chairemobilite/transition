...
describe('computeSegmentTimesByPeriodAndService', () => {
    ...
    test('should return empty object when periods array is empty', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([trip], [null], [], 1000);
    ...
    test('should group by period and service', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([amTripA, amTripB, middayTripA], [500], periods, 1000);
    ...
    test('should average trips within same period and service', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([trip1, trip2], [500], periods, 1000);
    ...
    test('should skip trips that fall before the first period', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([earlyTrip, amTrip], [null], periods, 1000);
    ...
    test('should assign trip shortly after last period to last period', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([lateTrip], [null], periods, 1000);
    ...
    test('should skip trip far beyond last period overflow threshold', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([veryLateTrip], [null], periods, 1000);
    ...
    test('should calculate speeds from total distance and period times', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([trip], [500, 500], periods, 1000);
    ...
    test('should set speeds to 0 when travel time is zero', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([trip], [null], periods, 1000);
    ...
    test('should keep different services separate in the same period', () => {
        ...
        const result = computeSegmentTimesByPeriodAndService([weekdayTrip, weekendTrip], [null], periods, 1000);
