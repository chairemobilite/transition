...
describe('Agencies, filtered by scenarios', () => {
    ...
    test('Get agencies for a specific scenario, all agencies expected', async() => {
        ...
        const agencies = await dbQueries.collectionForScenario(scenarioDbData.scenarios.scenarioIdWithBothServices);
    ...
    test('Get agencies for a specific scenario, filtered agencies expected', async () => {
        ...
        const agencies = await dbQueries.collectionForScenario(scenarioDbData.scenarios.scenarioIdWithService2);
    ...
    test('Get agencies for a specific scenario, with only agencies', async() => {
        const expectedAgencyIds = [scenarioDbData.agencyIds[0]];
        const agencies = await dbQueries.collectionForScenario(scenarioDbData.scenarios.scenarioIdWithBothServicesOnlyAgency1);
    ...
    test('Get agencies for a specific scenario, with exclude agencies', async() => {
        ...
        const agencies = await dbQueries.collectionForScenario(scenarioDbData.scenarios.scenarioIdWithBothServicesWithoutAgency1);
    ...
    test('Get agencies for a specific scenario, empty scenario', async() => {
        ...
        const agencies = await dbQueries.collectionForScenario(scenarioDbData.scenarios.scenarioIdWithEmptyServices);
