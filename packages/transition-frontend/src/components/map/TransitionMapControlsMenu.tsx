    ...
    return (
        <div className="tr__map-controls-dropdown" style={{ display: isOpen ? 'flex' : 'none' }}>
            <p
                ...
                onKeyDown={(e) => handleKeyDown(e, handleResetView)}
                role="button"
                tabIndex={0}
            >
            ...
            {onLayerChange && getCurrentLayer && (
                <>
                    ...
                    <p
                        ...
                        onKeyDown={(e) => handleKeyDown(e, handleOsmClick)}
                        role="button"
                        tabIndex={0}
                    ...
                    <p
                        ...
                        onKeyDown={(e) => handleKeyDown(e, handleAerialClick)}
                        role="button"
                        tabIndex={aerialTilesUrl && inRange ? 0 : -1}
                        aria-disabled={!(aerialTilesUrl && inRange)}
...
class MapControlsMenu {
    ...
    constructor(
        ...
        this.defaultCenter = defaultPreferences.map?.center ?? [0, 0];
        this.defaultZoom = defaultPreferences.map?.zoom ?? 0;
        this.t = t;
    ...
    onAdd(map: maplibregl.Map) {
        ...
        this.button.innerHTML = '<i class="fa fa-cog" aria-hidden="true" style="color: #333;"></i>';
