...
class ScenarioComparisonPanel extends ChangeEventsForm<ComparisonPanelProps, ComparisonFormState> {
    ...
    constructor(props: ComparisonPanelProps) {
        ...
        this.state = {
            ...
            formValues: {
                ...
                alternateScenario1Id: routingEngine.getAttributes().alternateScenario1Id,
                alternateScenario2Id: routingEngine.getAttributes().alternateScenario2Id,
    ...
    calculateRouting = async (refresh = false) => {
        ...
        try {
            ...
            routing.attributes.scenarioId = routing.attributes.alternateScenario1Id;
            const results1 = await calculateRouting(routing, refresh, { isCancelled, removeWalkOnlyPath: true });
            if (isCancelled()) {
                return;
            }
            routing.attributes.scenarioId = routing.attributes.alternateScenario2Id;
            const results2 = await calculateRouting(routing, refresh, { isCancelled, removeWalkOnlyPath: true });
            if (isCancelled()) {
                return;
            }
    ...
    onUpdateOD(
        ...
        this.setState({ object: routing, currentResult: [] });
    }
                    ...
                    <Collapsible trigger={this.props.t('form:basicFields')} open={true} transitionTime={100}>
                        <div className="tr__form-section">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
                                <InputWrapper
                                    label={this.props.t('transit:transitComparison:Scenario', { scenarioNumber: '1' })}
                                >
                                    <InputSelect
                                ...
                                <InputWrapper
                                    label={this.props.t('transit:transitComparison:Scenario', { scenarioNumber: '2' })}
                                    textColor="#ff00ff"
                                >
                                    <InputSelect
