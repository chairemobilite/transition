...
/**
 * Renders the stop nodes of the path as dots (one per node) with their labels below.
 * The terminal nodes (first/last) are drawn larger, and the two nodes bounding the
 * active segment are highlighted. Clicking a dot selects the adjacent segment.
 */
