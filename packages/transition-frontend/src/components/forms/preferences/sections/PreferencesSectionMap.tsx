            ...
            <div className="tr__form-section">
                <InputWrapper label={t('main:preferences:MapStyle')} help={t('main:preferences:MapStyleHelp')}>
                    <InputSelect
                        ...
                        // FIXME Do not allow to unset the background of the map
                        // as it causes the map state to not be propagated to
                        // the raster layer beneath. Saving the prefs in the
                        // current user session works, but after refreshing the
                        // page, the whole world is shown, though the deck.gl
                        // layer has the correct state.
                        noBlank={true}
                        t={t}
