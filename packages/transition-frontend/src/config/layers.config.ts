...
export const sectionLayers = {
    ...
    accessibilityMap: ['aggregatedOD', 'accessibilityMapPolygons', 'accessibilityMapPoints'],
    accessibilityComparison: ['accessibilityMapPolygons', 'accessibilityMapPoints'],
...
export const layersConfig = {
    ...
    transitNodesSelected: {
        ...
        strokeColor: (node: GeoJSON.Feature) =>
            node.properties?.isNodeInError === true ? [255, 0, 0] : [255, 255, 255],
        strokeWidth: 2,
        radius: 7,
        maxRadiusPixels: 15,
        minRadiusPixels: 5,
