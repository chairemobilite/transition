...
const mockSchema = {
    ...
    getFields: () => ({
        ...
        nestedOption: { type: 'nested' as const, required: true, schema: mockNestedSchema, i18nName: 'Nested Option' },
    }),
...
describe('getDefaultFieldsFromSchema', () => {
    ...
    test.each([{
        ...
        description: 'should not set options without defaults',
        schema: {
            ...mockSchema,
            getFields: () => ({
        ...
        description: 'optional nested field without initial values should not be generated if not provided',
        schema: {
            ...mockSchema,
            getFields: () => ({
                option1: stringOptionMock,
                option2: numberOptionMock,
                nestedOption: { type: 'nested' as const, required: false, schema: mockNestedSchema, i18nName: 'Nested Option' },
            }),
        },
        initialOptions: {},
        expected: { option1: 'default1', option2: 42 }
    }, {
        description: 'optional nested field with initial values should be generated',
        schema: {
            ...mockSchema,
            getFields: () => ({
                nestedOption: { type: 'nested' as const, required: false, schema: mockNestedSchema, i18nName: 'Nested Option' }
        ...
        initialOptions: { nestedOption: { } },
        expected: { nestedOption: { nestedOption1: true } }
