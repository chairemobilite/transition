 ...
 * options object.
 */
export class EvolutionaryAlgorithmDescriptor implements UserDefinedConfigSchema<EvolutionaryAlgorithmOptions> {
    ...
    validateFields = (fields: Partial<EvolutionaryAlgorithmOptions>): { valid: boolean; errors: string[] } => {
        let valid = true;
        const errors: string[] = [];

        const populationSizeMin = fields.populationSizeMin;
        const populationSizeMax = fields.populationSizeMax;
        ...
        const keepCandidates = fields.keepCandidates;
        ...
        const keepGenerations = fields.keepGenerations;
        const numberOfGenerations = fields.numberOfGenerations;
        if (
