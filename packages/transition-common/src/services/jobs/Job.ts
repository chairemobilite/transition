 ...
 *   or automatically according to some queue pre-conditions. Next possible
 ...
 * - 'cancelled': The job has been cancelled manually before completion and can
 *   only be resumed manually. This is a terminal state.
 *
