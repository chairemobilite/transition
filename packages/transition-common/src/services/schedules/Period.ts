...
export type TransitSchedulePeriod = {
    shortname: string;
    // TODO: make those periods translatable with i18next.
    // The key is the language code and the value is the name in that language (e.g. { fr: 'Pointe du matin', en: 'AM Peak' }).
...
export type PeriodsGroup = {
    // TODO: make those periods translatable with i18next.
    // The key is the language code and the value is the name in that language (e.g. { fr: 'Par défaut', en: 'Default' }).
    name: { [key: string]: string };
 ...
 */
export const findPeriodShortname = (
    periods: TransitSchedulePeriod[],
